import { API_KEY, BASE_URL, MID_BASE_URL, DEFAULT_X, DEFAULT_Y } from "@constants/config";
...
export async function fetchMidWeatherData(type) {
  ...
  const url = `${MID_BASE_URL}/${type}?serviceKey=${API_KEY}&numOfRows=10&pageNo=1&dataType=JSON&regId=11B10101&tmFc=${baseDate}${baseTime}`;

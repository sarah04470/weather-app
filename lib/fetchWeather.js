...
export async function fetchWeatherData(type) {
  ...
  const baseUrl = isLocal
    ? "http://localhost:5000/api/weather/VilageFcstInfoService_2.0"
    : "https://weather-proxy-server-altl.onrender.com/api/weather/VilageFcstInfoService_2.0";
...
export async function fetchMidWeatherData(type) {
  ...
  const baseUrl = isLocal
    ...
    : "https://weather-proxy-server-altl.onrender.com/api/weather/MidFcstInfoService";
